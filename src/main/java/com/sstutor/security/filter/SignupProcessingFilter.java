...
public class SignupProcessingFilter extends AbstractAuthenticationProcessingFilter {
    private static Logger logger = LoggerFactory.getLogger(SignupProcessingFilter.class);
    ...
    public SignupProcessingFilter(String defaultProcessUrl,  
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        if (StringUtils.isBlank(signupForm.getMobile()) || StringUtils.isBlank(signupForm.getName()) ) 
        {
        	throw new AuthenticationServiceException("Info missing for signup");
        }
        
    	User user = DBHandler.signup(signupForm, dataSource);
